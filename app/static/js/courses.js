...
function connectCourseExamSubject(selectId, titleId) {
...
connectCourseExamSubject('courseExamSubjectSelect', 'courseExamTitle');
connectCourseExamSubject('detailExamSubjectSelect', 'detailExamTitle');
